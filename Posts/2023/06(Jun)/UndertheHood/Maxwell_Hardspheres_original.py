...
sim_meta_data = '''
  Generated by Maxwell_Hardspheres_original.py.  This simulation of Maxwell hard 
  spheres uses the original algorithm of Bruce Sherwood.
'''
sim_name = 'MHS_original'        

data = {'raw_data':speed_configs,'meta_data':sim_meta_data,'name':sim_name}
fileObj = open('MaxwellHardSphere_original_data.pkl', 'wb')
