...
sim_meta_data = '''
  Generated by Maxwell_Hardspheres_revised_dt_determination_and_delta_momentum.py.  This simulation of Maxwell hard 
  spheres uses the revised rrel bounce algorithm in addition to a revised quadratic deltat
  calculation.
'''
sim_name = 'MHS_revised_dt_revised_rrel'

data = {'raw_data':speed_configs,'meta_data':sim_meta_data,'name':sim_name}
fileObj = open('MaxwellHardSphere_revised_dt_revised_rrel_data.pkl', 'wb')
