...
import os
os.system('cmd /c "del MB_bounce_on_contact.mp4"')
os.system('cmd /c "ffmpeg -r 5 -start_number 0 -i headon_%02d.png -c:v libx264 -r 80 -pix_fmt yuv420p MB_bounce_on_contact.mp4"');
